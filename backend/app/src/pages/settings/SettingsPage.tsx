...
function SettingsForm(props: {
  ...
  return (
    <>
      <CardSection title="注册与账号策略" description="控制公开注册与新用户默认角色。">
      ...
      <CardSection title="附件全局默认" description="未配置专属策略的实体沿用此默认。">
      ...
      <CardSection title="邮件 Provider" description="用于密码重置邮件；密码字段留空表示不修改。">
