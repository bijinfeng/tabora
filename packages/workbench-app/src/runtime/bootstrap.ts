  ...
  i18n.registerMessages("tabora.shell", [
    {
      ...
      messages: {
        ...
        "settingsHost.backAriaLabel": "返回工作台",
        "settingsHost.searchPlaceholder": "搜索设置项",
        ...
        "settingsHost.section.account": "账号",
        "settingsHost.section.account.description": "登录 Tabora 账号，用于云同步和设备注册。",
        "settingsHost.section.account.meta": "官方账号",
        "settingsHost.section.ai": "AI",
        "settingsHost.section.ai.description": "模型提供商、默认模型、连接测试和插件 AI 授权。",
        "settingsHost.section.ai.meta": "首次授权",
        "settingsHost.section.sync": "数据同步",
        "settingsHost.section.sync.description": "状态、范围和处理。",
        "settingsHost.section.sync.meta": "V1",
        ...
        "settingsHost.group.workspace": "工作台",
        "settingsHost.group.extensions": "扩展",
        "settingsHost.account.navName": "未登录",
        "settingsHost.account.navMeta": "本地模式",
        "settingsHost.account.navAvatar": "未",
        "settingsHost.windowSubtitle": "个人工作台配置 · 账号、布局、外观、搜索、AI、同步与插件",
        "settingsHost.status.ready": "设置已就绪",
        "settingsHost.status.sectionChanged": "已切换到{{sectionTitle}}",
        "settingsHost.status.reset": "已恢复当前页默认值",
        "settingsHost.status.saved": "设置已保存到本地",
        "settingsHost.action.reset": "恢复默认",
        "settingsHost.action.cancel": "取消",
        "settingsHost.action.save": "保存设置",
    ...
    },
    {
      ...
      messages: {
        ...
        "settingsHost.backAriaLabel": "Back to workbench",
        "settingsHost.searchPlaceholder": "Search settings",
        ...
        "settingsHost.section.account": "Account",
        "settingsHost.section.account.description":
          "Sign in to your Tabora account for cloud sync and device registration.",
        "settingsHost.section.account.meta": "Official account",
        "settingsHost.section.ai": "AI",
        "settingsHost.section.ai.description":
          "Model providers, default models, connection tests, and plugin AI grants.",
        "settingsHost.section.ai.meta": "First-use grant",
        "settingsHost.section.sync": "Data sync",
        "settingsHost.section.sync.description": "Status, scope, and handling.",
        "settingsHost.section.sync.meta": "V1",
        ...
        "settingsHost.section.about.meta": "V2",
        "settingsHost.group.workspace": "Workbench",
        "settingsHost.group.extensions": "Extensions",
        "settingsHost.account.navName": "Signed out",
        "settingsHost.account.navMeta": "Local mode",
        "settingsHost.account.navAvatar": "?",
        "settingsHost.windowSubtitle":
          "Workbench configuration · account, layout, appearance, search, AI, sync, and plugins",
        "settingsHost.status.ready": "Settings ready",
        "settingsHost.status.sectionChanged": "Switched to {{sectionTitle}}",
        "settingsHost.status.reset": "Restored defaults for this page",
        "settingsHost.status.saved": "Settings saved locally",
        "settingsHost.action.reset": "Restore defaults",
        "settingsHost.action.cancel": "Cancel",
        "settingsHost.action.save": "Save settings",
