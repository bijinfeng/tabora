...
vi.mock("../shared/WorkbenchShellViewBridge", async () => {
  const actual = await vi.importActual<typeof import("../shared/WorkbenchShellViewBridge")>(
    "../shared/WorkbenchShellViewBridge",
  )
  return {
    ...actual,
