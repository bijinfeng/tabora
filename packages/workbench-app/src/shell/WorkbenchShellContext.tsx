...
import type { SettingsPanelProviderContext, SettingsSectionId } from "@tabora/plugin-api"
...
export type WorkbenchShell = {
  ...
  settingsProviderContext: (
    surface: SettingsPanelProviderContext["surface"],
  ) => SettingsPanelProviderContext
  settingsRoute: {
    navigate(sectionId: SettingsSectionId): void
    home(): void
    isHome(): boolean
    close(): void
  }
