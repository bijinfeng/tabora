...
describe("CardSection", () => {
  it("renders its title, description, and trailing content", () => {
    const root = document.createElement("div")
    document.body.appendChild(root)
    render(
      () => (
        <CardSection title="标题" description="说明" trailing={<span data-testid="t">尾</span>}>
          内容
        </CardSection>
      ),
      root,
    ...
    expect(root.textContent).toContain("说明")
