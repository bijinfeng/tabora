...
export const styles = stylex.create({
  ...
  searchBar: {
    ...
    borderWidth: 1,
    boxShadow:
      "0 2px 8px color-mix(in srgb, rgb(var(--tbr-color-shadow)) 4%, transparent), inset 0 1px 0 color-mix(in srgb, rgb(var(--tbr-color-surface)) 72%, transparent)",
    display: "flex",
    gap: 10,
    height: 46,
    paddingInline: 12,
    ...
    ":focus-within": {
      ...
      boxShadow:
        "0 0 0 3px color-mix(in srgb, rgb(var(--tbr-color-accent-soft)) 72%, transparent), 0 12px 32px color-mix(in srgb, rgb(var(--tbr-color-accent)) 10%, transparent), inset 0 1px 0 color-mix(in srgb, rgb(var(--tbr-color-surface)) 72%, transparent)",
    },
  },
  searchProvider: {
    alignItems: "center",
  ...
  searchProviderButton: {
    alignItems: "center",
    backgroundColor: "color-mix(in srgb, rgb(var(--tbr-color-surface-soft)) 88%, transparent)",
    borderColor: "color-mix(in srgb, rgb(var(--tbr-color-line)) 88%, transparent)",
    borderRadius: 999,
    borderStyle: "solid",
    borderWidth: 1,
  ...
  searchProviderDot: {
    backgroundColor:
      "color-mix(in srgb, rgb(var(--tbr-color-accent)) 82%, rgb(var(--tbr-color-inverse)))",
    borderRadius: "50%",
    display: "block",
    flexShrink: 0,
    height: 6,
  ...
  searchDivider: {
    backgroundColor: "color-mix(in srgb, rgb(var(--tbr-color-line)) 86%, transparent)",
    flexShrink: 0,
    height: 18,
    transitionDuration: "var(--tbr-dur-fast)",
