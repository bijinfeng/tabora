...
visual_references:
  workbench_prototype: docs/design/工作台交互原型.html
...
`docs/design/工作台交互原型.html`、`docs/design/04-官网预览.html` 和 `docs/design/05-官网下载.html` 只作为可视原型或静态预览资产，不再承载规范事实。若预览与本文件冲突，以本文件为准，并同步更新预览或实现。
